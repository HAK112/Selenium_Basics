...
import com.test.pages.HomePageGuru;
import com.test.pages.LoginPageGuru;

public class LoginTestGuru {
	String driverPath = "resource//drivers//chromedriver.exe//";
    
    WebDriver driver;
    LoginPageGuru objLogin;
    HomePageGuru objHomePage;
    ...
    public void test_Home_Page_Appear_Correct(){
    	...
    	objLogin = new LoginPageGuru(driver);
    	...
    	// go the next page
    	objHomePage = new HomePageGuru(driver);
